...
| `GITHUB_APP_ID`          |   App*   | The ID of your GitHub App. *Required if using GitHub App authentication.*                                         |
| `GITHUB_APP_PRIVATE_KEY` |   App*   | The Base64-encoded private key for your GitHub App. *Required if using GitHub App authentication.*                |
| `GITHUB_TOKEN`           |   PAT*   | A GitHub Personal Access Token with the `repo` scope. *Required if using PAT authentication.*                     |